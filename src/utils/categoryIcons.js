// Shared icon paths for wiki categories, used by both the home page section
// cards and the generic list page's empty-state icon.
...
export const defaultCategoryIconPath = categoryIconPaths.pathways;
