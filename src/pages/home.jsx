          ...
          <div className="hero-content text-center border border-primary rounded-lg p-4 md:p-8 flex-col lg:flex-row-reverse gap-6 lg:gap-12 bg-base-100 shadow-lg">
             ...
             <div className="w-full max-w-3xl">
               ...
               <div className="flex gap-4 justify-center flex-wrap">
                 <Link to="/lotm_wiki/characters" className="btn btn-primary normal-case text-base">
                   Characters
                 </Link>
                 <Link to="/lotm_wiki/pathways" className="btn btn-secondary normal-case text-base">
                   Pathways
                 </Link>
               </div>
            </div>
